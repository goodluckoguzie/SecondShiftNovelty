...
EXTRACT_SYSTEM = """You are a care-log extraction engine for a family carer of a person with dementia in the UK.
...
JSON shape:
{"events":[{"type":"medication|symptom|meal|sleep|mood|incident|note","subtype":"dose_late|dose_missed|confusion|agitation|appetite_low|","event_time":"ISO-8601 if known else null","detail":"short","confidence":0.0}],"clarifying_question":null,"confirmation":"short UK English confirmation"}
"""
...
def chat_json(prompt: str, system: str, model: str | None = None) -> dict[str, Any]:
    payload = {
